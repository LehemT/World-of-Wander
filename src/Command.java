/**
 * This class represents a command issued by the user. It contains a primary command
 * word and an optional second word, to help in parsing user input and executing actions.
 * 
...
public class Command
{
    ...
    /**
     * Return the first word of the command. If the
